"""
Django settings for uleague_8 project.
...
ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ['https://uleague-8-production.up.railway.app','https://*.127.0.0.1']
...
WSGI_APPLICATION = 'uleague_8.wsgi.application'
