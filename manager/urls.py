...
from manager.views import show_team_registration_page, show_team_page, show_add_player_page, show_add_trainer_page, show_stadium_page, show_rent_stadium_page
